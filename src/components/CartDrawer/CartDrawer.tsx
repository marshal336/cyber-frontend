...
import { Button, Sheet, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetTitle, SheetTrigger } from '../ui'
...
export default function CartDrawer({ className, children }: PropsWithChildren<ICartDrawerProps>) {
                ...
                <div className="flex flex-col items-start justify-between flex-1 h-full">
                    ...
                    <div className="flex flex-col overflow-auto">
                        ...
                        {(cart?.cartItems.length === 0 || !cart) && (
                            <div className="text-4xl uppercase text-red-600">
                                No Items
                            </div>
                        )}
